                    ...
                    <div class="d-flex flex-wrap">
                        ...
                        <div class="ml-auto align-self-center">
                            <ul class="list-inline m-b-0">
                                ...
                                <li>
                                    <h6 class="text-muted text-info"><i class="fa fa-circle font-10 m-r-10"></i>Site B
                                    </h6>
                                </li>
                            </ul>
                        </div>
                        ...
                        <tbody>
                            <tr>
                                <td style="width:40px"><img
                                        src="{{ asset('backend/images/browser/chrome-logo.png') }}" alt=logo /></td>
                                <td>Google Chrome</td>
                                <td class="text-right"><span class="label label-light-info">23%</span></td>
                            </tr>
                            <tr>
                                <td><img src="{{ asset('backend/images/browser/firefox-logo.png') }}" alt=logo /></td>
                                <td>Mozila Firefox</td>
                                <td class="text-right"><span class="label label-light-success">15%</span></td>
                            </tr>
                            <tr>
                                <td><img src="{{ asset('backend/images/browser/safari-logo.png') }}" alt=logo /></td>
                                <td>Apple Safari</td>
                                <td class="text-right"><span class="label label-light-primary">07%</span></td>
                            </tr>
                            <tr>
                                <td><img src="{{ asset('backend/images/browser/internet-logo.png') }}" alt=logo /></td>
                                <td>Internet Explorer</td>
                                <td class="text-right"><span class="label label-light-warning">09%</span></td>
                            </tr>
                            <tr>
                                <td><img src="{{ asset('backend/images/browser/opera-logo.png') }}" alt=logo /></td>
                                <td>Opera mini</td>
